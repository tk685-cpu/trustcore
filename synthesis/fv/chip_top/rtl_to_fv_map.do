...
# Generated on: Wed Jul 22 14:35:04 KST 2026 (Wed Jul 22 05:35:04 UTC 2026)
...
set logfile fv/chip_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/chip_top -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /home/taewan/trustcore/synthesis/../lib/khu_etri05_stdcells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/sha256.v ../rtl/ascon128.v ../rtl/crypto_fsm.v ../rtl/spi_slave.v ../rtl/spi_top.v ../rtl/spi_buffer_ctrl.v ../rtl/chip_top.v
elaborate_design -golden -root {chip_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/chip_top/fv_map.v.gz
elaborate_design -revised -root {chip_top}
...
set_analyze_option -mapping_file fv/chip_top/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.chip_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.chip_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.chip_top.rtl.fv_map.rpt
